...
ACumpleJuanCharacter::ACumpleJuanCharacter()
{
...
void ACumpleJuanCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACumpleJuanCharacter::Move);
...
void ACumpleJuanCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACumpleJuanCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
